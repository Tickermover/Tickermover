...
def _system() -> str:
    return (
        ...
        "- No investment advice: never say buy, sell, hold, accumulate, or "
        "give a price target. Stay descriptive.\n"
        "- 1–2 sentences, at most ~40 words. Plain English, no hype, no emoji.\n"
