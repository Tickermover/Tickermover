"""
TickerMover — Stripe Billing  |  tickermover.com
Hosted Checkout, Billing Portal, and webhook verification.

Plans:
  free — 180 stocks, Hot List, Fundamentals (no login required)
  pro  — Watchlist, Email Alerts, Real-time data
...
Secret: set STRIPE_WEBHOOK_SECRET in env or config.py.
"""
