...
def _research_system() -> str:
    return (
        ...
        "1. THE VERDICT — one sentence, wrapped in ** so it renders bold, saying "
        "where the company stands right now: the single most important tension. "
        "Write the sentence ITSELF and nothing else — do NOT prefix it with a "
        "label such as 'Bold verdict:', 'Verdict:' or 'Summary:'. It is displayed "
        "on its own as the headline, so a label reads as a mistake.\n"
...
def _overview_system() -> str:
    ...
    return (
        ...
        "1. THE VERDICT — one sentence, wrapped in ** so it renders bold, saying "
        "where the company stands. Write the sentence ITSELF and nothing else — no "
        "'Bold verdict:' / 'Verdict:' label in front of it; the sentence is shown "
